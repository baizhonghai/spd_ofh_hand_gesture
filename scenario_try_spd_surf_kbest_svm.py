...
if __name__ == '__main__':
    ...
    selector_spd = SelectKBest(mutual_info_classif, k=topK)
    X_train = torch.tensor(selector_spd.fit_transform(X_train, Y_train))
    X_test = torch.tensor(selector_spd.transform(X_test))
    ...
    logger.info(f'paramers:topk:{topK},accuracy:{accuracy}')
