...
addpath(genpath('/Users/baizhonghai/TP/HandGestureRecognition/flann/src/matlab'))
...
maindir = '/Users/baizhonghai/TP/HandGestureRecognition/datasets/Cambridge_Hand_Gesture_keyframe/surf_feature';
feaDir = '/Users/baizhonghai/TP/HandGestureRecognition/datasets/Cambridge_Hand_Gesture_keyframe/surfBOW';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [Centroids, Indexs]=kmeans(X',K,'MaxIter', 1000); 
